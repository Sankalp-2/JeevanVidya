...
<div class="wc-wraper featured-cta-wraper featured-cta-two">
	<div class="wc-container">
		<div class="wc-grid-12 featured-header text-center">
			
			<?php if(get_theme_mod('extra_cta_heading_text')){?>
				<h4 class="section-subheader"><?php echo esc_html(get_theme_mod('extra_cta_heading_text')); ?>
			...
			if(get_theme_mod('extra_cta_message_text')){?>
				<h2 class="section-heading"><?php echo esc_html(get_theme_mod('extra_cta_message_text')); ?></h2>
			<?php }?>
